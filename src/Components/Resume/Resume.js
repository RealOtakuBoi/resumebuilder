...
function Resume(props) {
    ...
    <div key={"projects"} className={`${Styles.section} ${Styles.projects}`}>
      ...
      <div className={Styles.content}>
        <div className={Styles.item}>
            ...
            <p className={Styles.overview}>This is not a real project it is a dummy project made to test the sekeleton</p>
            <ul className={Styles.points}>
                <li className={Styles.point}>This is first point</li>
                <li className={Styles.point}>This is first point</li>
                <li className={Styles.point}>This is first point</li>
                <li className={Styles.point}>This is first point</li>
            </ul>
    ...
    <div key={"education"} className={`${Styles.section} ${Styles.education}`}>
      ...
      <div className={Styles.content}>
        <div className={Styles.item}>
            ...
            <p className={Styles.subTitle}>Collage Name</p>
            <p className={Styles.date}>
                <Calendar/> 12/08/2022 - 2/02/2023
            </p>
            </div>
  ...
  const otherSection = (
    <div key={"other"} className={`${Styles.section} ${Styles.other}`}>
      ...
      <div className={Styles.content}>
        <p className={Styles.overview}>This is some dummy text</p>
      </div>
    </div>
  );
